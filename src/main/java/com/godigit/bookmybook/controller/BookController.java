...
public class BookController {
     ...
     */
    @PostMapping()
    public ResponseEntity<BookDTO> createBook(@RequestHeader String token, @Valid @RequestBody BookDTO bookDTO) throws IOException {
     ...
     *
     * @param token    The user token given in a @RequestHeader for authorizing the user.
    ...
    public ResponseEntity<BookDTO> addImage(@RequestHeader String token,@PathVariable long image_id,@PathVariable long book_id) throws IOException {
    ...
    @GetMapping("/{book_id}")
    public ResponseEntity<BookDTO> getBook(@RequestHeader String token, @PathVariable long book_id) {
    ...
    public ResponseEntity<String> change(@RequestHeader String token, @PathVariable long book_id, @PathVariable int quantity) {
